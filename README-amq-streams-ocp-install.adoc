...
* Create it by adding *KafkaTopic* CRD entry
...
* Adding *ConfigMap* and *directly on zookeeper* 2 more option

=== Test 

==== Testing using an external application

    Clone this git repo to test the access from to your new Kafka cluster:
