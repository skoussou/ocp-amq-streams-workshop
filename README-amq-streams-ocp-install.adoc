...
* Adding Topic via Template configuring Topic *ConfigMap* and *directly on zookeeper* 2 more option
...
* Go to client application https://github.com/skoussou/ocp-amq-streams-workshop/tree/master/clients/kafka-remote-client[kafka-remote-client]
	...
	cd ./ocp-amq-streams-workshop/tree/master/clients/kafka-remote-client
