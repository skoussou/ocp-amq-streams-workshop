...
//		props.put("bootstrap.servers", "my-cluster-kafka-bootstrap-myproject.192.168.42.249.nip.io:443");
	props.put("bootstrap.servers", "my-cluster-kafka-bootstrap-amq-streams-ephemeral.192.168.42.249.nip.io");
		props.put("acks", "all");
		props.put("retries", 0);
